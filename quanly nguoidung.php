...
VALUES (01,'user','admin@gmail.com','$2y$10$jKD0W3pvp0USRXbJn8bzz.f6CehMJgtdWBQCwvXkMQlSEAgSoTgWq','Quản trị viên','admin','active');
    ...
    <form method="POST">
        ...
        <?php
            if(isset($_GET['timeout']))
                echo '<div class="error">Phiên đăng nhập đã hết hạn!</div>';
